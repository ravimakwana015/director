	...
	<section class="content">
		<div class="box box-info">
			<div class="box-header with-border ">
				<h3 class="box-title">Add New Enter</h3>
			...
			<div class="box-body">
				{{ Form::open(['route' => 'discover.store','role' => 'form', 'method' => 'post', 'id' => 'create-cate', 'files' => true]) }}
	...
	$('.upload-image').on('click', function (ev) {
		resize.croppie('result', {
			...
			$.ajax({
				...
				url: "{{ route('upload-discover-icon') }}",
				type: "POST",
				data: {"image":img},
				success: function (data) {
					$('#loading').hide();
					var path ='{{ asset('public/img/discover/') }}';
    ...
    <script>
        $(function () {
            ...
            $("#countryCareer").select2({
                ...
                {{--    var data = {id: '{{ $discover->country }}', text: '{{ $discover->country }}'};--}}
                {{--    callback(data);--}}
                {{--},--}}
