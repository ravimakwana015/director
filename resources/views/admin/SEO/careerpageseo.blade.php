	...
	<section class="content">
		...
		<div class="box box-info">
			<div class="box-header with-border ">
				<h3 class="box-title">Career Detail Page SEO Update</h3>
			...
			{!! Form::model($careerpageseo, ['route' => ['careerpage.update', $careerpageseo->id], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'POST', 'files' => true]) !!}
			<div class="box-body">
				<div class="row">
					<div class="col-md-12">
