<div class="main winner-page">
    <div class="custom-container">
        <section class="winnerdetail-wrap">
            ...
            <div class="btn-wrap" >
                <a href="javascript:;" class="btn" id="view_winner">View Winners Profile</a>
            </div>
            <div class="winner-profile-wrap" style="display: none;" >
                <div class="winner-profile">
                    @if(isset($discover->getResult->usersid))
                    <a href="{{ route('profile-details',str_replace(' ', '-', strtolower($discover->getResult->usersid->username))) }}">
                        <div class="job-logo">
