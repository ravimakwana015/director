    ...
    <div class="chat-wrap-main">
            ...
            <div class="previous-chat">
                ...
                <div class="top-wrap">
                    <div class="search-bar">
                        ...
                        <input placeholder="Search.." v-model="username" @change="searchUser">
                    </div>
                </div>
                    ...
                    <div class="chat chat-1" @click="activeFriend=friend.id">
                        <div class="img-wrap">
                            <template v-if="friend.profile_picture">
                                <a :href="'/producerseye/Code/profile-details/'+friend.username"><img :src="'/producerseye/Code/public/img/profile_picture/'+friend.profile_picture" width="100" height="100"></a>
                            </template>
                            <template v-else>
        ...
        <section class="chat-section">
            <div class="chat-wrap">
                <div class="head-wrap">
                    <div class="to-name">
                        <p>To: <a :href="'/producerseye/Code/profile-details/'+activeFriendData.username" style="color: #A9A9A9;">{{ activeFriendData.first_name }} {{ activeFriendData.last_name
                            }}</a></p>
                ...
                <div class="write-message" v-if="isReportUser==null">
                    <div class="type-wrap">
							<textarea placeholder="Type something..." v-model="message"
                                      label="Enter Message"
                                      single-line
                                      @keydown="onTyping"></textarea>
                    </div>
                    <!-- <div class="emoji">
        ...
        <section class="my-profile-intro">
            ...
            <div class="information"
                 v-bind:class="{ 'actor': activeFriendData.user_type=='1', 'model': activeFriendData.user_type=='2', 'musician': activeFriendData.user_type=='3',
                 'crew': activeFriendData.user_type=='4' }">
                ...
                <template v-if="activeFriendData.id > 0">
                    <div class="info-img">
                        <template v-if="activeFriendData.profile_picture">
                            <a :href="'/producerseye/Code/profile-details/'+activeFriendData.username"><img :src="'/producerseye/Code/public/img/profile_picture/'+activeFriendData.profile_picture" width="100"
                                                                                          height="100"></a>
                        </template>
                        <template v-else>
                            <a :href="'/producerseye/Code/profile-details/'+activeFriendData.username"><img src="/producerseye/Code/public/front/images/no-image-available.png" alt="img" width="100" height="100"></a>
                        </template>
                    </div>
                </template>
                <template v-else>
                ...
                axios.get(this.path + '/chatUsers').then(response => {
                    ...
                    if (this.friends.length > 0) {
                        for (var prop in this.users) {
                            if (this.users[prop].id == this.friend_id) {
                                this.activeFriend = this.users[prop].id;
                            }
                        }
                    } else {
